...
import co.unicauca.gestiontg.ui.resources.RoundedPasswordField;
...
public class registerFrame extends javax.swing.JFrame {
    ...
    public registerFrame(Servicio servicioCompartido) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Tf_correoElectronico = new co.unicauca.gestiontg.ui.resources.RoundedTextField(20, java.awt.Color.GRAY, 1);
        jPanel1 = new javax.swing.JPanel();
        pn_logInData = new RoundedPanel(30);
        txtNombres = new co.unicauca.gestiontg.ui.resources.RoundedTextField(20, java.awt.Color.BLACK, 1,"Nombres");
        jLabel3 = new javax.swing.JLabel();
        btn_logIn = new RoundedButton("Iniciar Sesión") ;
        txtApellidos = new co.unicauca.gestiontg.ui.resources.RoundedTextField(20, java.awt.Color.BLACK, 1,"Apellidos");
        cbPrograma = new javax.swing.JComboBox<>();
        txtCorreoElectronico = new co.unicauca.gestiontg.ui.resources.RoundedTextField(20, java.awt.Color.BLACK, 1,"Correo Electrónico");
        txtTelefono = new co.unicauca.gestiontg.ui.resources.RoundedTextField(20, java.awt.Color.BLACK, 1,"Teléfono (opcional)");
        ...
        txtNombres.setPreferredSize(new java.awt.Dimension(257, 45));
        ...
        txtTelefono.setPreferredSize(new java.awt.Dimension(257, 45));
        ...
        pswContrasenia.setPreferredSize(new java.awt.Dimension(257, 45));
                    ...
                    .addGroup(pn_logInDataLayout.createSequentialGroup()
                        .addGroup(pn_logInDataLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pn_logInDataLayout.createSequentialGroup()
                                .addGap(3, 3, 3)
                                .addGroup(pn_logInDataLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(txtCorreoElectronico, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(pn_logInDataLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private boolean validarCorreo(){
        return service.validarCorreoInstitucional(user.getCorreo()).equals("OK");
    }
    
    private boolean validarContrasenia(){
        return service.validarContrasenia(user.getContrasenia()).equals("OK");
    }
