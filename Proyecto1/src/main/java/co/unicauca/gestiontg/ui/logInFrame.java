...
public class logInFrame extends javax.swing.JFrame implements Observer {
     ...
     */
    public logInFrame(Servicio servicioCompartido) {
        initComponents();
        setLocationRelativeTo(null);
        this.service = servicioCompartido;
        
        Usuario u = servicioCompartido.getUltimoUsuario();
        if (u != null) {
            lblUltimoUsuario.setText("Último usuario registrado: " + u.getNombres());
        } 
    ...
    private void initComponents() {
        ...
        btnInicioSesion.setMaximumSize(new java.awt.Dimension(82, 23));
        ...
        lblUltimoUsuario.setForeground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(402, 402, 402))))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(lblUltimoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 374, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblUltimoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35)
                .addComponent(pnlogInData, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        if (espaciosVacios() == false) {
            if (validar) {
                if (rol.equals("Estudiante")) {
                    ...
                    estudianteFrame nuevaVentana = new estudianteFrame(service);
                    ...
                    docenteFrame nuevaVentana = new docenteFrame(service);
                    nuevaVentana.setVisible(true);
                    nuevaVentana.setLocationRelativeTo(null); // centrar
                    this.dispose();
                }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        registerFrame nuevaVentana = new registerFrame(service);
        nuevaVentana.setVisible(true);
        nuevaVentana.setLocationRelativeTo(null); // centrar
    ...
    public void update(Object o) {
        if (o instanceof Servicio) {
            Usuario u = ((Servicio) o).getUltimoUsuario();
            if (u != null) {
                lblUltimoUsuario.setText("Último usuario registrado: " + u.getNombres());
            }
        }   
